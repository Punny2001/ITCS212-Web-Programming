...
//Insert student
route.post('/insert-student', cors(), function (req, res) {
...
//Update student
route.put('/update-student', cors(), function (req, res) {
...
//Delete student
route.delete('/delete-student', cors(), function (req, res) {
    let student_id = req.body.student.StudentID;
    if (!student_id) {
...
//Select all students
route.get('/student', cors(), function (req, res) {
...
//Select student
route.get('/student/:id', cors(), function (req, res) {
